            ...
            <div className="flex-1 flex flex-col">
              ...
              >
                <motion.p
                  ...
                  className="w-72 lg:w-[350px] h-auto lg:text-sm text-xs bg-white/10 backdrop-blur-lg lg:py-6 px-3 py-4 lg:px-[22px] rounded-2xl xl:ml-24 lg:ml-10 mr-2 text-amber-50"
                >
