  ...
  return (
    ...
    >
      <div className=" h-full flex justify-between items-center md:w-[85vw] w-full px-5 md:pb-10 bg-cover bg-center bg-[url('/images/home-3.jpg')] before:absolute before:inset-0 before:bg-black/40 before:z-0">
        <div className="w-full flex flex-col h-full md:px-0 md:pt-14 md:mr-6 ">
          <div className="absolute inset-x-0 top-0 h-1/4 bg-gradient-to-b from-black/90 from-20% via-black/90 via-70% to-transparent to-100%" />
            ...
            <div className="flex-1 flex flex-col">
              ...
              >
                <motion.p
                  ...
                  className="w-72 lg:w-[350px] h-auto lg:text-sm text-xs bg-white/10 backdrop-blur-lg lg:py-6 px-3 py-4 lg:px-[22px] rounded-2xl xl:ml-24 lg:ml-10 mr-2"
                >
                ...
                <motion.p
                  ...
                  transition={{ duration: 1.2, ease: "easeOut", delay: 1.5 }}
                  className="w-72 lg:w-[350px] h-auto lg:text-sm text-xs bg-white/10 backdrop-blur-lg lg:py-6 px-3 py-4 lg:px-[22px] rounded-2xl ml-auto md:mr-10"
                >
