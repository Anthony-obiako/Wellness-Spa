...
const buttonContents = [
  {
    ...
    text1: "Get bonuses for each visit and use them to pay for the following services",
  ...
  },
  {
    ...
    text1: "Enjoy the peaceful atmosphere and recieve the utmost attention from our staff",
    text2: "For your comfort and privacy we strictly limit the number of visitors at the same time",
  ...
  },
  {
    ...
    text1: "The interior of our salon features canadian cedar and himalayan salt highlighting the premium quaklity of the design",
    text2: "Every element is carefully crafted to create a sense of comfort and sophistication for our guests",
  ...
  },
  {
    ...
    text2: "In the relaxation area complimentary refreshments are available for our guests",
...
<div className="h-full flex flex-col justify-between items-center w-full px-5 md:pb-7 pb-7 md:px-4 bg-cover bg-center overflow-hidden">
        <AnimatePresence mode='wait'>
          <motion.div
            ...
            style={{ backgroundImage: `url(${buttonContents[activeIndex].bgImage})` }}
          />
        </AnimatePresence>

        <div className="w-full flex flex-col h-full before:z-10 px-4 md:px-[100px] md:pt-14">
          <h1 className="font-activa text-xl md:text-3xl lg:text-4xl text-amber-50 md:mb-16 mb-20 z-10 w-full lg:ml-20 md:ml-14 ml-5">
        ...
        <div className="md:flex gap-4 w-[90vw]">
          {[
            ...
            >
              ...
              <p className="opacity-60 ml-auto hidden md:block">
                0{index + 1}
              </p>
            </button>
          ))}
